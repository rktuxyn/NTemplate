...
namespace NTemplate {
	namespace Compiler {
		...
		inline void RunScript(const v8::FunctionCallbackInfo<v8::Value>& args);
		inline v8::Local<v8::Value> ParseScript(v8::Isolate* isolate,
		...
		*/
		void ParseScript(const v8::FunctionCallbackInfo<v8::Value>& args);
		inline v8::Local<v8::Value> RunTemplateScript(v8::Isolate* isolate,
