...
inline void Compiler::RunScript(v8::Isolate* isolate, v8::Local<v8::String> source) {
	{
#if _HAS_EXCEPTIONS
		_Try
#endif	
...
inline void Compiler::RunScript(const v8::FunctionCallbackInfo<v8::Value>& args) {
	{
		...
		_NCO RunScript(isolate, v8::Local<v8::String>::Cast(args[0]));
#if _HAS_EXCEPTIONS
		_Catch
			isolate->ThrowException(v8::Exception::TypeError(
				v8::String::NewFromUtf8(isolate, e.what())));
...
inline v8::Local<v8::Value> Compiler::ParseScript(v8::Isolate* isolate,
...
*/
inline void Compiler::ParseScript(const v8::FunctionCallbackInfo<v8::Value>& args) {
	{
		v8::Isolate* isolate = v8::Isolate::GetCurrent();
#if _HAS_EXCEPTIONS
		_Try
			...
			*/
			...
			v8::Local<v8::Value> resp = _NCO ParseScript(isolate, v8::Local<v8::String>::Cast(args[0]), v8::Local<v8::Value>::Cast(args[2]), v8::Local<v8::Value>::Cast(args[3]));
...
inline v8::Local<v8::Value> Compiler::RunTemplateScript(v8::Isolate* isolate,
	std::string& source, v8::Local<v8::Local<v8::Value>> innerArg, bool isAsync = false) {
		{
